    ...
    <Container fluid className="project-section">
      ...
      <Container>
        <h1 className="project-heading">
          My <strong className="purple">Learning Phase </strong>Journey
        </h1>
        <p style={{ color: "white", fontSize: "1.1em", maxWidth: "700px", margin: "0 auto 10px auto" }}>
          "Every expert was once a beginner — never forget the journey that shaped you."
        </p>
        <p style={{ color: "rgb(155 126 172)", marginBottom: "40px" }}>
          These are the projects I built when I was just starting out in development. They represent
          the foundation of my learning and the curiosity that drove me forward. I keep them here
          as a reminder that every great developer once wrote their first line of code.
        </p>
